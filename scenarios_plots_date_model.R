...
plots_scenarios_date_model_comparison[[1]] <- 
  plots_scenarios_date_model_comparison[[1]] +
  geom_rug(date_model_raw, aes(x = day)) +
...
plots_scenarios_date_model_comparison[[2]] <- 
  plots_scenarios_date_model_comparison[[2]] +
  geom_rug(date_model_raw, aes(x = avalanche)) +
...
plots_scenarios_date_model_comparison[[3]] <- 
  plots_scenarios_date_model_comparison[[3]] +
  geom_rug(date_model_raw, aes(x = solar_radiation)) +
...
plots_scenarios_date_model_comparison[[4]] <- 
  plots_scenarios_date_model_comparison[[4]] +
  geom_rug(date_model_raw, aes(x = temperature)) +
...
plots_scenarios_date_model_comparison[[5]] <- 
  plots_scenarios_date_model_comparison[[5]] +
  geom_rug(date_model_raw, aes(x = snow_diff)) +
