...
%Beispiel für diese Kovariablen sind das Datum, die Uhrzeit, die Temperatur und die Lawinenwarnstufe. 
...
Die mathematischen Formeln und Konzepte aus diesem Kapitel basieren, wenn nicht anders vermerkt, auf dem Buch \glqq{Regression-Modelle, Methoden und Anwendungen}\grqq ~von Ludwig Fahrmeir et al..
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{plots/erf_art_plot}
